...
import { X, Shield, Cookie, Menu } from 'lucide-react';
...
export default function LegalDrawer() {
  ...
  const legalLinks = [
    { 
      ...
      to: "/privacidad",
      content: "En Evocarelab, la privacidad de sus datos biométricos y personales es nuestra prioridad. Cumplimos con el RGPD para asegurar que su información sea procesada con los más altos estándares de seguridad criptográfica."
    },
    { 
      title: "Política de Cookies", 
      icon: <Cookie className="w-4 h-4" />,
      to: "/cookies",
      content: "Utilizamos cookies técnicas y de personalización para mejorar su experiencia sensorial en nuestro laboratorio digital. No rastreamos datos sin su consentimiento explícito."
    }
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <span className="[writing-mode:vertical-lr] rotate-180 text-[8px] uppercase tracking-[0.3em] font-bold py-2">Legal</span>
      </button>
          ...
          <>
            ...
            >
              <div className="flex justify-between items-center mb-16">
                <span className="text-[10px] uppercase tracking-[0.5em] text-gold font-bold">Información</span>
                <button 
                  onClick={() => setIsOpen(false)}
